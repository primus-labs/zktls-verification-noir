/**
 * Test 2: verify_hash — BusinessProgram (Poseidon2 hash-based verification)
 *
 * Profiles and executes hash-based attestation verification on devnet.
 */
...
console.log("TEST 2: verify_hash — BusinessProgram (Poseidon2 hashing)");
console.log("=".repeat(70));
...
const profile = await contract.methods.verify_hash(
  ...
  parsed.requestUrls, parsed.allowedUrls, parsed.dataHashes, parsed.plainJsonResponses, parsed.id,
