// Test: The request URL is not amongst the allowed urls -> tx should fail
...
const ALLOWED_URLS = ["https://test.com", "https://www.test2.com", "https://test3.com"];
...
try {
  ...
  console.log(`\nTransaction failed as expected (corrupted allowed URLs rejected).`);
  console.log(`   Duration: ${((Date.now() - start) / 1000).toFixed(1)}s`);
