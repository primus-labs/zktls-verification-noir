...
import OKXVerifierContractArtifactJson from '../../okx_example/target/okx_example-OKXVerifier.json' with { type: 'json' };
...
H: {
  ...
  public declare methods: {
    ...
    /** verify_comm(public_key_x: array, public_key_y: array, hash: array, signature: array, request_urls: array, allowed_urls: array, coms_per_group: array, rnds_per_group: array, msgs_chunks_per_group: array, msgs_per_group: array, H: struct, id: field) */
